declare module "@cep/csinterface" {
    /**
    ...
    */
    class Extension {
        constructor(public id: string, public name: string, public mainPath: string, public basePath: string, public windowType: CSXSWindowType, public width: number, public height: number, public minWidth: number, public minHeight: number, public maxWidth: number, public maxHeight: number, public defaultExtensionDataXml: any, public specialExtensionDataXml: any, public requiredRuntimeList: Runtime[], public isAutoVisible: boolean, public isPluginExtension: boolean);
    }
     ...
     */
    class CSEvent {
        constructor(public type: string, public scope: 'GLOBAL' | 'APPLICATION', public appId?: string, public extensionId?: string);
    ...
    */
    class UIColor {
        constructor(public type: number, public antialiasLevel: number, public color: RGBColor | GradientColor);
    }
     ...
     */
    class AppSkinInfo {
        constructor(public baseFontFamily: string, public baseFontSize: number, public appBarBackgroundColor: UIColor, public panelBackgroundColor: UIColor, public appBarBackgroundColorSRGB: UIColor, public panelBackgroundColorSRGB: UIColor, public systemHighlightColor: RGBColor);
    }
     ...
     */
    class HostEnvironment {
        constructor(public appName: string, public appVersion: string, public appLocale: string, public appUILocale: string, public appId: string, public isAppOnline: boolean, public appSkinInfo: AppSkinInfo);
    }
     ...
     */
    class HostCapabilities {
        constructor(public EXTENDED_PANEL_MENU: boolean, public EXTENDED_PANEL_ICONS: boolean, public DELEGATE_APE_ENGINE: boolean, public SUPPORT_HTML_EXTENSIONS: boolean, public DISABLE_FLASH_EXTENSIONS: boolean);
    }
    ...
    class CSInterface {
         ...
         */
        public updatePanelMenuItem(menuItemLabel: string, enabled: boolean, checked: boolean);
         ...
         */
        public registerInvalidCertificateCallback(callback: any);
